        ...
        <>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 divide-y divide-gray-50">
            {data.clientes_top.slice(0, 10).map((c) => {
              const contactUrl = chatwootBaseUrl && chatwootAccountId
              ...
              return (
                <div key={c.telefono}
                  ...
                  <a href={contactUrl}
                    ...
                    className="ml-1 flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-lg bg-blue-50 hover:bg-blue-100 transition-colors"
                    title={chatwootBaseUrl ? 'Abrir en Chatwoot' : 'Abrir WhatsApp'}>
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill={chatwootBaseUrl ? '#1E40AF' : '#25D366'}>
                      <path d="M12 2C6.477 2 2 6.477 2 12c0 1.89.525 3.66 1.438 5.168L2.046 21.9a.5.5 0 0 0 .613.613l4.732-1.392A9.956 9.956 0 0 0 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18a7.958 7.958 0 0 1-4.078-1.117l-.292-.174-3.02.889.889-3.02-.174-.292A7.958 7.958 0 0 1 4 12c0-4.418 3.582-8 8-8s8 3.582 8 8-3.582 8-8 8zm4-6H8a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2zm-2-4H8a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2z"/>
                    </svg>
                  </a>
                </div>
              )
